...
const HeroSection = () => {
  ...
  style={{ 
    backgroundImage: `url('/backgroundImage.png')` 
      ...
      <p className='max-w-md to-gray-300'>In a post world where cities ride on wheels and consume each other to survive, two poeple meet in london and try to stop a conspiracy.</p>
